...
/**
 * Module-level cache shared across all hook instances/mounts in this app.
 * Prevents re-fetching the same resource on every remount (e.g. navigating
 * away from the lesson plan list and back).
 * @type {Map<string, any>}
 */
 ...
 * @param {string} cacheKey - Unique key, e.g. 'lesson-plans'.
