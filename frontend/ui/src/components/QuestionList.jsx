...
export default function QuestionList({ questions, filterMeta }) {
  ...
  // Build title from filter metadata passed down from the parent form
  const buildTitle = () => {
    if (filterMeta) {
      const parts = []
  ...
  // Download one copy (student or teacher) and trigger browser save
  ...
  // Click handler: downloads student copy, waits 600ms, then teacher copy
    ...
    <>
      ...
      <div className="download-bar">
        <div className="dl-info">
          ...
          <small>Each download saves two files — student copy (no answers) and teacher copy (with answers &amp; topics).</small>
