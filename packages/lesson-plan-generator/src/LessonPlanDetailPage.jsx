...
import { useApiResource, useApiMutation, invalidateResource } from '@brainz/shared-ui';
...
export default function LessonPlanDetailPage() {
  ...
  const handleDelete = async () => {
    ...
    // '..' + relative: 'path' -- same mount-depth-independence reasoning
    // as every other internal navigation in this package. Current URL is
    // ".../lesson-plans/<id>"; this strips the id and lands back on
    // ".../lesson-plans/", regardless of how deep the package is mounted.
  ...
  if (error) {
    return (
      <div className="lp-page">
        ...
        <Link to=".." relative="path" className="lp-btn lp-btn-ghost">← Back to Lesson Plans</Link>
      </div>
    );
  }
